...
fun yyAction17 (strm, lastMatch : yymatch) = (yystrm := strm;   T.ASSN )
fun yyAction18 (strm, lastMatch : yymatch) = (yystrm := strm;   T.EQ )
fun yyAction19 (strm, lastMatch : yymatch) = (yystrm := strm;   T.GT )
fun yyAction20 (strm, lastMatch : yymatch) = (yystrm := strm;   T.GE )
fun yyAction21 (strm, lastMatch : yymatch) = (yystrm := strm;   T.QUESTION )
fun yyAction22 (strm, lastMatch : yymatch) = (yystrm := strm;   T.LBRACK )
fun yyAction23 (strm, lastMatch : yymatch) = (yystrm := strm;   T.RBRACK )
fun yyAction24 (strm, lastMatch : yymatch) = (yystrm := strm;   T.LB )
fun yyAction25 (strm, lastMatch : yymatch) = (yystrm := strm;   T.OR )
fun yyAction26 (strm, lastMatch : yymatch) = (yystrm := strm;   T.RB )
fun yyAction27 (strm, lastMatch : yymatch) = (yystrm := strm;   T.TBOOL )
fun yyAction28 (strm, lastMatch : yymatch) = (yystrm := strm;   T.DO )
fun yyAction29 (strm, lastMatch : yymatch) = (yystrm := strm;   T.TDBL )
fun yyAction30 (strm, lastMatch : yymatch) = (yystrm := strm;   T.ELSE )
fun yyAction31 (strm, lastMatch : yymatch) = (yystrm := strm;   T.FALSE )
fun yyAction32 (strm, lastMatch : yymatch) = (yystrm := strm;   T.FOR )
fun yyAction33 (strm, lastMatch : yymatch) = (yystrm := strm;   T.IF )
fun yyAction34 (strm, lastMatch : yymatch) = (yystrm := strm;   T.TINT )
fun yyAction35 (strm, lastMatch : yymatch) = (yystrm := strm;   T.RETURN )
fun yyAction36 (strm, lastMatch : yymatch) = (yystrm := strm;   T.TSTRING )
fun yyAction37 (strm, lastMatch : yymatch) = (yystrm := strm;   T.TRUE )
fun yyAction38 (strm, lastMatch : yymatch) = (yystrm := strm;   T.TVOID )
fun yyAction39 (strm, lastMatch : yymatch) = (yystrm := strm;   T.WHILE )
fun yyAction40 (strm, lastMatch : yymatch) = (yystrm := strm;   skip() )
fun yyAction41 (strm, lastMatch : yymatch) = (yystrm := strm;   skip() )
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5F
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ46(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp = 0wx41
                  then yyQ46(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp < 0wx41
                  then yyAction28(strm, yyNO_MATCH)
              ...
              then yyQ80(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp < 0wx75
              then if inp = 0wx60
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ46(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = 0wx5B
              ...
              then if inp = 0wx3A
                  ...
                  then if inp <= 0wx2F
                      then yyAction27(strm, yyNO_MATCH)
                      else yyQ46(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp <= 0wx40
                  then yyAction27(strm, yyNO_MATCH)
                  else yyQ46(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = 0wx60
...
fun yyQ20 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction19(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3D
              then yyQ87(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
...
fun yyQ19 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction17(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3D
              then yyQ88(strm', yyMATCH(strm, yyAction17, yyNO_MATCH))
...
fun yyQ18 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction15(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3D
              then yyQ89(strm', yyMATCH(strm, yyAction15, yyNO_MATCH))
       ...
       of NONE => yyAction40(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx2A
              ...
              else yyQ95(strm', yyMATCH(strm, yyAction40, yyNO_MATCH))
      (* end case *))
       ...
       of NONE => yyAction12(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx2B
              ...
              then if inp = 0wx2A
                  then yyQ90(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
                  else yyAction12(strm, yyNO_MATCH)
            else if inp = 0wx2F
              then yyQ91(strm', yyMATCH(strm, yyAction12, yyNO_MATCH))
              else yyAction12(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction48(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wxA
              ...
              else yyQ100(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = 0wx23
              ...
              then if inp = 0wx22
                  ...
                  else yyQ102(strm', yyMATCH(strm, yyAction48, yyNO_MATCH))
            else if inp = 0wx5C
...
fun yyQ3 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction0(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = 0wx3D
              then yyQ106(strm', yyMATCH(strm, yyAction0, yyNO_MATCH))
